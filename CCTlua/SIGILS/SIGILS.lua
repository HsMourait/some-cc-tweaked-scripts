local files = {
  ...
  'sigils/PipeGraph.lua',
  'sigils/PipeSaturation.lua',
  'sigils/pipeBatcher.lua',
  'sigils/pipe.lua',
  'sigils/Set.lua',
...
for i, path in ipairs(files) do
  tasks[i] = function()
    local req, err = http.get('https://raw.gitmirror.com/fechan/SIGILS/master/computercraft/' .. path)
